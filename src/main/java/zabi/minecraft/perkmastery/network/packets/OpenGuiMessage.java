...
//			Log.i(message.guiExtra);
			if (message.guiExtra==-1)
				player.openGui(PerkMastery.instance, GuiHandler.IDs.GUI_BOOK.ordinal(), player.worldObj, (int) player.posX, (int) player.posY, (int) player.posZ);
