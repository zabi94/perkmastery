...
public class Config {
    ...
    public static void reload() {
    	...
    	maxBookshelvesScanned = 		configuration.getInt("maxBookshelves", Configuration.CATEGORY_GENERAL, 30, 1, 100, "The max number of bookshelves scanned by the tome of experience");
