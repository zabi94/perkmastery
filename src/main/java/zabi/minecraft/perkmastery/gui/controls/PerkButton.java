...
public class PerkButton extends GuiButton {
	...
	public void clicked() {
		...
		if (ExtendedPlayer.hasPlayerAquired(p, PlayerClass.values()[cls], lvl)) {
			ExtendedPlayer.toggle(p,!ExtendedPlayer.isEnabled(p,PlayerClass.values()[cls], lvl), PlayerClass.values()[cls], lvl);
		} else {
	...
	public boolean isAbilityPurchased() {
		return ExtendedPlayer.getAbilityLevelFor(GuiPerks.player, PlayerClass.values()[cls])>=lvl ||
				ExtendedPlayer.getAbilityLevelFor(Minecraft.getMinecraft().thePlayer, PlayerClass.values()[cls])>=lvl;
	}
	public boolean isAbilityEnabled() {
		
		return ExtendedPlayer.isEnabled(GuiPerks.player, PlayerClass.values()[cls], lvl) ||
				ExtendedPlayer.isEnabled(Minecraft.getMinecraft().thePlayer, PlayerClass.values()[cls], lvl);
	}
	...
	public String getTooltip() {
		...
		switch (cls) {
		case 0:return StatCollector.translateToLocal("perk.mage."+lvl);
		case 1:return StatCollector.translateToLocal("perk.archer."+lvl);
		case 2:return StatCollector.translateToLocal("perk.miner."+lvl);
		case 3:return StatCollector.translateToLocal("perk.builder."+lvl);
		case 4:return StatCollector.translateToLocal("perk.warrior."+lvl);
		case 5:return StatCollector.translateToLocal("perk.explorer."+lvl);
		}
		return null;
	}
	...
	public String getTooltipDescription() {
		...
		switch (cls) {
		case 0:return StatCollector.translateToLocal("perk.desc.mage."+lvl);
		case 1:return StatCollector.translateToLocal("perk.desc.archer."+lvl);
		case 2:return StatCollector.translateToLocal("perk.desc.miner."+lvl);
		case 3:return StatCollector.translateToLocal("perk.desc.builder."+lvl);
		case 4:return StatCollector.translateToLocal("perk.desc.warrior."+lvl);
		case 5:return StatCollector.translateToLocal("perk.desc.explorer."+lvl);
		}
		return null;
	}
