...
//            Log.i(item.getItem().getUnlocalizedName());
	...
	public String getTooltip() {
		switch (id) {
		case 0:return StatCollector.translateToLocal("classes.mage");
		case 1:return StatCollector.translateToLocal("classes.archer");
		case 2:return StatCollector.translateToLocal("classes.miner");
		case 3:return StatCollector.translateToLocal("classes.builder");
		case 4:return StatCollector.translateToLocal("classes.warrior");
		case 5:return StatCollector.translateToLocal("classes.explorer");
		}
		return null;
	}
	...
	public EnumChatFormatting getFormatting() {
		switch (id) {
		case 0:return EnumChatFormatting.LIGHT_PURPLE;
		case 1:return EnumChatFormatting.YELLOW;
		case 2:return EnumChatFormatting.DARK_GREEN;
		case 3:return EnumChatFormatting.GOLD;
		case 4:return EnumChatFormatting.RED;
		case 5:return EnumChatFormatting.AQUA;
		}
